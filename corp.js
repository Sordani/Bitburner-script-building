...
/**@type {NS} */
	...
	startstuff() {
		...
		for (let city of this.cities) {
			...
			this.ns.corporationc.setSmartSupply(this.agriName, city, true);
		...
		this.ns.corporationc.hireAdVert(agriName);
